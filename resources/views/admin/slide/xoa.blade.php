    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ Lang::get('sub.delete') }} Slide <strong>{{cutString($s->gioithieu, 40)}}</strong></h5>
            ...
            <div class="modal-body">
                <div class="container" align="right">
                    ...
                    <a href="admin/slide/xoa/{{$s->idslide}}" title="{{ Lang::get('sub.delete') }}">
